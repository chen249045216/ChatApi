    ...
    <div class="message-main" :style="{ opacity: messageOpacity }">
      <div class="message-content">
        ...
        <template v-for="item in activeRoom.messages">
          <div class="message-content-message" :key="item.userId + item.createTime" :class="{ 'text-right': item.userId === user.userId }">
            ...
            <div>
              ...
              <div class="message-content-text" v-text="_parseText(item.content)" v-else-if="item.messageType === 0"></div>
              <div class="message-content-image" v-if="item.messageType === 1" :style="getImageStyle(item.content)">
                <viewer style="display:flex;align-items:center;">
                  <img :src="imagebaseUrl + item.content" alt="" />
                </viewer>
              </div>
            </div>
          </div>
